...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https:///ossified-variraptor-b8b.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '10da586b2b68803ea36af1a417230b07',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Math, Number Theory', // 网站关键词 英文逗号隔开
